...
import com.example.opsc7312part1.databinding.ActivityDirectionsBinding
...
class Place_Directions(private val fragmentNavigation: FragmentNavigation) : Fragment() {
    ...
    private lateinit var binding: FragmentPlaceDirectionsBinding
    ...
    private var blocation : Boolean = false
    ...
    private var isVoiceInstructionsMuted = false
        set(value) {
            field = value
            if (value) {
                binding.soundButton.muteAndExtend(Place_Directions.BUTTON_ANIMATION_DURATION)
                voiceInstructionsPlayer.volume(SpeechVolume(0f))
            } else {
                binding.soundButton.unmuteAndExtend(Place_Directions.BUTTON_ANIMATION_DURATION)
    ...
    override fun onCreateView(
        ...
        binding = FragmentPlaceDirectionsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private val locationObserver = object : LocationObserver {
        ...
        override fun onNewLocationMatcherResult(locationMatcherResult: LocationMatcherResult) {
            ...
            navigationLocationProvider.changePosition(
             ...
             if (blocation == false)
            {
                val fixedPoint = Point.fromLngLat(DirLong, DirLat)
                findRoute(fixedPoint)
                blocation = true
            }
...
//        requireActivity().setContentView(binding.root)
        ...
        binding.recenter.setOnClickListener {
            ...
            binding.routeOverview.showTextAndExtend(Place_Directions.BUTTON_ANIMATION_DURATION)
        }
    ...
    private fun findRoute(destination: Point) {
        ...
        if (originLocation == null) {
            Log.d("MapboxDebug", "Origin location is null.")
            return
        }
    ...
    private fun clearRouteAndStopNavigation() {
        ...
        fragmentNavigation.replaceFragment(Nearby_Stores(), "Nearby Stores")
    }
